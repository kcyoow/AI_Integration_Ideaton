      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        >
          ...
          <div
            ...
            className={`${showSuggestedQuestions ? 'h-[36rem]' : 'h-[40rem]'} overflow-y-auto p-6 space-y-4`}
          >
              ...
              <div className="flex flex-nowrap gap-2">
                {suggestedQuestions.map((question, index) => (
                  <motion.button
                    ...
                    className="px-3 py-1 bg-gray-100 text-gray-700 rounded-full text-base font-medium hover:bg-gray-200 transition-colors"
                  >
                    {question}
                  </motion.button>
                ))}
